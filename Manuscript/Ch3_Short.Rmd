...
__Figure 1.__ Principal coordinates analysis of altered and intact sites for bats (A) and birds (B) based on the Ochiai dissimilarity index. 
...
ann <- data.frame(value = -Inf, lab = LETTERS[1:4], 
                  parameter = "omega", 
                  model = factor(c("full", "common", "full_noTurnover", "common_noTurnover"), levels = c("full", "common", "full_noTurnover", "common_noTurnover")), 
