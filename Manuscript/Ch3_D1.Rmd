...
The destructive effect of human activities on the biosphere is of global concern. It is increasingly recognised that these effects extend many thousands of years into the past [@Lyons2016; @Maezumi2018], across the entire planet [@Sanderson2002; @Ellis2008], and may continue to be felt tens of millions of years into the future [@Novacek2001; @Alroy2008]. Its effects are so pervasive that almost no aspects of ecology remain unchanged [@Ellis2015]. In order to help mitigate the effect of human activities and steer conservation initiatives, a pressing objective for ecologists is to understand the formation of spatial patterns in species distributions, biodiversity, and abundance, and how human impacts modify these processes. 

It is generally accepted that where species are found, and in what abundances, is driven by the historical and present interplay of dispersal abilities (can the species physically access a place?), climate and local environment (can the species survive in that place?), and biotic interactions (can the species reliably coexist with other species using the place, or else prevail over any incumbent competitors?) [@McGill2010]. Thought subject has long been contentious among both ecologists [@McGill2010; @Araujo2014] and paleontologists [@Ezard2016; @Marshall2016], evidence has begun to accumulate that the effects of biotic interactions scale up to measurably influence community assembly at much larger spatial scales [@Araujo2007; @Pollock2014]. The same appears to be true for biotic processes occurring over geological timescales, as mounting evidence demonstrates that interactions such as competition and facilitation can be instrumental in structuring spatial patterns over thousands of years [@Toth2019], as well as the diversification and extinction of entire clades on timescales of millions of years [@Sepkoski1984; @Alroy2010].

The impact of human activities complicates the modern community assembly process, both directly by changing the composition of species on the landscape, and indirectly by changing aspects of the three original driving mechanisms. Directly, humans translocate invasive species [@Lemke2019], cut down forests to make way for alternative land uses [@Soares-Filho2006], and facilitate wholesale extinctions [@Lyons2004; @Sandom2014; @VanDerKaars2017]. Pre-Columbian agricultural practices changed the composition of plants in Amazonia by encouraging the dominance of edible plants [@Maezumi2018]. Several papers document decreases in diversity, increases in homogenization [@Dornelas2014, @Toth2014], and reduced abundance of species. Changes in composition add and remove potential biotic interactions from a system, and can eventually compromise ecosystem function, particularly when it results in homogenization [@Magurran2018]. Direct changes in the composition of species can affect biotic interactions, habitats, and dispersal via feedbacks between species and their surroundings [@Rodewald2016; @Reinhardt2010].
...
Unfortunately, biotic interactions are difficult to monitor directly, meaning that quantitative methods to estimate their effects are sorely needed. Co-occurrence analysis allows for a nuanced look at differences in community assembly across space or time [@Blois2013; @Kay2017]. It quantifies the extent to which species occur together more often than expected by chance (aggregation) or less often than expected (segregation). This approach has been used for decades [@Diamond1975], and has recently been used to examine community assembly of species under human disturbance [@Lane2014; @Kay2017], changing climate conditions [@Araujo2007], across environmental gradients [@Bar-Massada2017], and across ecological [@Tulloch2016] and geological timescales [@Lyons2016]. Although associations based on co-occurrence analysis do not necessarily equate to biotic interactions [@Freilich2018], they represent the spatial pattern resulting from the interacting effects of climate, dispersal, biotic interactions, and human impacts. By incorporating information about climate (e.g. [@Toth2019; @Blois2014]), functional ecology (e.g. [@Smith2016]), or human disturbance, co-occurrence can be used to estimate cumulative changes in the effect of biotic interactions on community assembly patterns. 

 Although it has not escaped substantial criticism, the notion that competition is an important driver of community assembly amassed much empirical support in its early years [@Schoener1983], and evidence has continued to mount. A considerable proportion of this body of literature is devoted to tropical birds [@Terborgh1975; @Remsen1995; @Jankowski2010; @Freed2014; @Weinstein2016], but competition in other taxa, such as primates [@Kamilar2011], has also been examined. Based on competition theory, we expect competing species to either coexist in a dynamic equillibrium or to exclude one another, i.e., be found together less often than species which do not compete. Studies evaluating the effects of human disturbance on the outcome of interspecific competition, however, are scarce. 
...
Abundance data were dowloaded from the Ecological Register (http://ecoregister.org) on 5th June 2020 for mistnetted bats and birds from the Neotropics, defined as all areas in the western hemisphere south of the Tropic of Cancer (23.44˚N). Samples were combined if they were within the same 11.1 km equal-area grid cell, sourced from the same study, and represented the same habitat and alteration category. We also dowloaded Register metadata for the species and sites in the abundance tables, including coordinates for sites and dietary guild assignments for species. Guild assignments were based on a large set of recently published individual papers. Sampling and reporting was standardised across the samples, as all were mist-netted samples with consistent mesh size, harp net samples were excluded, and almost all nets were placed at ground level. Every sample consisted of a minimum of 20 individuals and the vast majority of sites had more than 50, with the average number of individuals per sample being `r mean(colSums(PAn[["bat"]]))` for bats and `r mean(colSums(PAn[["bird"]]))` for birds.  The data consisted of a total of `r sum(PAn[["bat"]])` bat and `r sum(PAn[['bird']])` bird individuals from `r ncol(PAn[['bat']])` and `r ncol(PAn[['bird']])` sites, respectively. Maps of the sites are plotted in Figure S1.
...
In this framework, a net change in co-occurrence across altered versus unaltered sites can create several patterns: (a) an increase in the strength of aggregations indicates more co-occurrence; (b) an increase in the strength of segregations indicates less co-occurrence; (c) an increase in the strength of both aggregations and segregations and signals that species are more tightly linked to the occurrence of their pairs; and (d) a decrease in the strength of all associations indicates that pairs are closer to being randomly distributed with respect to one another. The difference in co-occurrence patterns associated with altered versus unaltered habitats can suggest biological mechanisms. 
For instance, reduced co-occurrence in competing pairs compared to non-competing pairs suggests that competitive exclusion is occurring. Greater co-occurrence of competing pairs in altered sites can mean that particular altered sites (i.e., those that provide the requisite dietary resource) can support the coexistence of more species in the same dietary group more often. Tighter co-occurrence can indicate that species form clusters, for instance, due to an increase in the spatial compartmentation of food resources introduced by habitat alteration (e.g., pastures provide an abundance of one type of food and plantations provide another type). Weakened associations indicate that the spatial structure of food resources is less defined, and species are dispersed more randomly or are very widespread.

*__The effect of turnover.__*
Overall changes observed in association patterns could result from pairs changing their behaviour or the intensity of their competition in altered vs. unaltered habitats. Conversely, a shift in species composition, and therefore the presence of a different suite of pairs, could also cause disparities between the two habitat types. To investigate these possibilities, we separated species into two groups: those occurring in both types of habitats ("shared") and those occurring in only one type of habitat ("unique"). Pairs were then classified as occurring between two shared, two unique, or one shared and one unique species. If shared-shared pairs (i.e., pairs that occur in both habitat types) show differences in associations then the former hypothesis is supported, and if unique-shared and unique-unique pairs show differences then the latter hypothesis is supported. A combination of both hypotheses is also possible.
...
For each analysis, we report differences in the strength of aggregations and segregations between altered and unaltered habitats (refer to the Supplement for similar analyses on the proportion of aggregations). In our results, we present the ratio of the observed to expected measurement variable (i.e., the average magnitude of aggregation or segregation), with unaltered results plotted against altered results in a scatterplot where each point represents an iteration of the randomisation. We include 95% confidence ellipses and rug plots to help interpret the plots. For further explanation on the interpretation of the co-occurrence scatterplots, see Figure S2. 
...
Neither bats nor birds exhibited a significant differences in the beta diversity of altered and unaltered sites (Wilcoxon rank sum test, p _bat_ = `r round(pbeta[[1]]$p.value, 3)`; p _bird_ = `r round(pbeta[[2]]$p.value, 3)`). Bats had an order of magnitude higher similarity than birds overall, indicating that spatial turnover in birds is much higher and suggesting the two taxa have very different community structures. This is unsurprising because Neotropical bats frequently have geographic ranges spanning almost the entire realm, unlike Neotropical birds.
